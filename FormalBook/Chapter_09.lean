...
namespace FormalBook.Chapter09
...
theorem bijective_f : f.Bijective := by
...
theorem preimageT_eq_S : f ⁻¹' T = S :=
  ((eq_preimage_iff_image_eq bijective_f).mpr fS_eq_T).symm

theorem isOpen_T : IsOpen T := by
  refine IsOpen.and (IsOpen.and ?_ ?_) (IsOpen.and ?_ ?_) <;> apply isOpen_lt <;> fun_prop

theorem isOpen_S : IsOpen S := by
...
theorem measurableSet_T : MeasurableSet T := by
  unfold T
  measurability

theorem measurableSet_S : MeasurableSet S := by
  unfold S S1 S2 S3
  measurability

/-- Primitive appearing in the first integral after substitution -/
noncomputable def g := fun u : ℝ => arctan (u / √(1 - u ^ 2)) ^ 2

/-- Primitive appearing in the second integral after substitution -/
noncomputable def h := fun u : ℝ => -2 * arctan ((1 - u) / √(1 - u ^ 2)) ^ 2

theorem deriv_g_eq (u : ℝ) (hu : u ∈ Ioo 0 1) :
...
theorem integrable_deriv_g_explicit : IntervalIntegrable
...
theorem integrable_deriv_g : IntervalIntegrable (deriv g) volume 0 2⁻¹ := by
...
theorem deriv_h_eq (u : ℝ) (hu : u ∈ Ioo 0 1) :
...
theorem integrable_deriv_h_explicit : IntervalIntegrable
  ...
  apply IntervalIntegrable.mono_fun h1 (by measurability)
...
theorem integrable_deriv_h : IntervalIntegrable (deriv h) volume 2⁻¹ 1 := by
  rw [intervalIntegrable_iff_integrableOn_Ioo_of_le (by norm_num)]
...
theorem continuousOn_uIcc_g : ContinuousOn g (uIcc 0 2⁻¹) := by
...
theorem differentiableAt_uIoo_g u (hu : u ∈ uIoo 0 2⁻¹) : DifferentiableAt ℝ g u := by
  simp at hu
...
theorem continuousOn_uIcc_h : ContinuousOn h (uIcc 2⁻¹ 1) := by
...
theorem differentiableAt_uIoo_h u (hu : u ∈ uIoo 2⁻¹ 1) : DifferentiableAt ℝ h u := by
...
theorem zeta_two : ∑' n : ℕ, ((n : ℝ) ^ 2)⁻¹ = π ^ 2 / 6 := calc
  _ = ∑' n : ℕ, (n : ℝ)⁻¹ ^ 2 := by simp
  ...
  _ = ∑' n : ℕ, ((n : ℝ) + 1)⁻¹ ^ 2 := by
    ...
    · simp
  _ = ∑' n : ℕ, (∫ x : ℝ in 0..1, x ^ n) ^ 2 := by simp
  ...
  _ = (∑' n : ℕ, ofReal (∫ x : ℝ in 0..1, x ^ n) ^ 2).toReal := by
    rw [tsum_toReal_eq]
    · congr 1 with n
  ...
  _ = _ := by
    ...
    congr 1
    calc
    _ = ∑' n : ℕ, (∫⁻ x : ℝ in Ioo 0 1, ofReal (x ^ n)) ^ 2 := by
      congr! 3 with n
    ...
    -- This will facilitate later uses of Fubini's theorem.
    _ = ∑' n : ℕ, (∫⁻ x : ℝ, (Ioo 0 1).indicator 1 x * ofReal x ^ n) ^ 2 := by
      congr! 3 with n
      simp [←lintegral_indicator, indicator]
    _ = ∑' n : ℕ, (∫⁻ x : ℝ, (Ioo 0 1).indicator 1 x * ofReal x ^ n) *
                    (∫⁻ y : ℝ, (Ioo 0 1).indicator 1 y * ofReal y ^ n) := by ring_nf
    _ = ∑' n : ℕ, ∫⁻ x : ℝ, (Ioo 0 1).indicator 1 x * ofReal x ^ n *
                    ∫⁻ y : ℝ, (Ioo 0 1).indicator 1 y * ofReal y ^ n := by
      congr! 2 with n
      rw [lintegral_mul_const _ (by measurability)]
    _ = ∑' n : ℕ, ∫⁻ x : ℝ, ∫⁻ y : ℝ,
          (Ioo 0 1).indicator 1 x * (Ioo 0 1).indicator 1 y * (ofReal x * ofReal y) ^ n := by
      congr! 4 with n x
      rw [←lintegral_const_mul _ (by measurability)]
      ring_nf
    -- Now we exchange the sum and the integrals using Tonelli's theorem twice.
    -- Using ℝ≥0∞ Lebesgue integrals saves us from checking integrability conditions.
    _ = ∫⁻ x : ℝ, ∑' n : ℕ, ∫⁻ y : ℝ,
          (Ioo 0 1).indicator 1 x * (Ioo 0 1).indicator 1 y * (ofReal x * ofReal y) ^ n := by
    ...
    _ = ∫⁻ x : ℝ, ∫⁻ y : ℝ, ∑' n : ℕ,
      ...
      congr! 2 with x
      rw [lintegral_tsum (by measurability)]
    _ = ∫⁻ x : ℝ, ∫⁻ y : ℝ, (Ioo 0 1).indicator 1 x * (Ioo 0 1).indicator 1 y * ∑' n : ℕ,
          (ofReal x * ofReal y) ^ n := by
      congr! 4 with x y
      rw [ENNReal.tsum_mul_left]
    _ = ∫⁻ x : ℝ, ∫⁻ y : ℝ, (Ioo 0 1).indicator 1 x * (Ioo 0 1).indicator 1 y *
        ((1 - ofReal x * ofReal y)⁻¹) := by
      congr! 4 with x y
      simp only [tsum_geometric]
    _ = ∫⁻ x : ℝ, ∫⁻ y : ℝ, T.indicator 1 (x, y) * ((1 - ofReal x * ofReal y)⁻¹) := by
      congr! 5 with x y
      simp [T, indicator]
      grind only
    -- Using Fubini's theorem, we couple integrals over ℝ × ℝ to prepare for a change of variables.
    _ = ∫⁻ xy : ℝ × ℝ, T.indicator 1 xy * ((1 - ofReal xy.1 * ofReal xy.2)⁻¹) := by
      rw [←lintegral_prod fun xy => T.indicator 1 xy * ((1 - ofReal xy.1 * ofReal xy.2)⁻¹)]
      · rw [←Measure.volume_eq_prod]
      · unfold T; measurability
    _ = ∫⁻ xy : ℝ × ℝ in T, (1 - ofReal xy.1 * ofReal xy.2)⁻¹ := by
      rw [←lintegral_indicator]
      · simp [indicator]
      · exact measurableSet_T
    _ = ∫⁻ xy : ℝ × ℝ in f '' S, (1 - ofReal xy.1 * ofReal xy.2)⁻¹ := by rw [fS_eq_T]
    -- Now we perform the change of variables x = u - v, y = u + v.
    _ = ∫⁻ uv : ℝ × ℝ in S, 2 * ((1 - ofReal (uv.1 - uv.2) * ofReal (uv.1 + uv.2))⁻¹) := by
    ...
    _ = ∫⁻ uv : ℝ × ℝ in S, 2 * ((ofReal 1 - ofReal ((uv.1 - uv.2) * (uv.1 + uv.2)))⁻¹) := by
      ...
      grind only
    _ = ∫⁻ uv : ℝ × ℝ in S, 2 * (ofReal (1 - (uv.1 - uv.2) * (uv.1 + uv.2)))⁻¹ := by
      refine setLIntegral_congr_fun measurableSet_S fun (u, v) huv => ?_
      congr 2
      rw [ofReal_sub]
      ...
      simp [S, S1, S2, S3] at huv
      grind only
    _ = 2 * ∫⁻ uv : ℝ × ℝ in S, ofReal ((1 - (uv.1 - uv.2) * (uv.1 + uv.2))⁻¹) := by
      rw [←lintegral_const_mul _ (by measurability)]
      refine setLIntegral_congr_fun measurableSet_S fun (u, v) huv => ?_
      congr 1
    ...
    _ = 2 * ((∫⁻ uv : ℝ × ℝ in S1, ofReal ((1 - (uv.1 - uv.2) * (uv.1 + uv.2))⁻¹)) +
            (∫⁻ uv : ℝ × ℝ in S2, ofReal ((1 - (uv.1 - uv.2) * (uv.1 + uv.2))⁻¹)) +
            (∫⁻ uv : ℝ × ℝ in S3, ofReal ((1 - (uv.1 - uv.2) * (uv.1 + uv.2))⁻¹))) := by
      congr 1
      unfold S
      rw [lintegral_union, lintegral_union]
      · unfold S2; measurability
      · grind [S1, S2]
      · unfold S3; measurability
      · grind [S1, S2, S3]
    _ = (2 * ∫⁻ uv : ℝ × ℝ in S1, ofReal ((1 - (uv.1 - uv.2) * (uv.1 + uv.2))⁻¹)) +
        2 * ∫⁻ uv : ℝ × ℝ in S2, ofReal ((1 - (uv.1 - uv.2) * (uv.1 + uv.2))⁻¹) := by
      rw [setLIntegral_measure_zero S3]
      · ring
      · simp [S3, volume]
    _ = (2 * ∫⁻ uv : ℝ × ℝ, S1.indicator 1 uv * ofReal ((1 - (uv.1 - uv.2) * (uv.1 + uv.2))⁻¹)) +
        2 * ∫⁻ uv : ℝ × ℝ, S2.indicator 1 uv * ofReal ((1 - (uv.1 - uv.2) * (uv.1 + uv.2))⁻¹) := by
      congr 2
      · rw [←lintegral_indicator]
        · simp [indicator]
        · unfold S1; measurability
      · rw [←lintegral_indicator]
        · simp [indicator]
        · unfold S2; measurability
    -- Separate the integrals over u and v using Fubini's theorem again.
    _ = (2 * ∫⁻ u : ℝ, ∫⁻ v : ℝ, S1.indicator 1 (u, v) * ofReal ((1 - (u - v) * (u + v))⁻¹)) +
        2 * ∫⁻ u : ℝ, ∫⁻ v : ℝ, S2.indicator 1 (u, v) * ofReal ((1 - (u - v) * (u + v))⁻¹) := by
      congr 2
    ...
    _ = (2 * ∫⁻ u : ℝ, ∫⁻ v : ℝ, (Ioo 0 2⁻¹).indicator 1 u * (Ioo (-u) u).indicator 1 v *
            ofReal ((1 - (u - v) * (u + v))⁻¹)) +
      ...
      · congr! 5 with u v
        simp [S2, indicator]
        grind only
    _ = (2 * ∫⁻ u : ℝ, (Ioo 0 2⁻¹).indicator 1 u * ∫⁻ v : ℝ, (Ioo (-u) u).indicator 1 v *
            ofReal ((1 - (u - v) * (u + v))⁻¹)) +
      ...
      · congr! 2 with u
        ...
        · ring_nf
        · measurability
    _ = (2 * ∫⁻ u : ℝ in Ioo 0 2⁻¹, ∫⁻ v : ℝ in Ioo (-u) u, ofReal ((1 - (u - v) * (u + v))⁻¹)) +
        2 * ∫⁻ u : ℝ in Ioo 2⁻¹ 1, ∫⁻ v : ℝ in Ioo (-(1 - u)) (1 - u), ofReal ((1 - (u - v) * (u + v))⁻¹) := by
      simp [←lintegral_indicator, indicator]
    -- Pull the ofReal upwards again to convert the inner integrals to ℝ.
    _ = (2 * ∫⁻ u : ℝ in Ioo 0 2⁻¹, ofReal (∫ v : ℝ in Ioo (-u) u, (1 - (u - v) * (u + v))⁻¹)) +
        2 * ∫⁻ u : ℝ in Ioo 2⁻¹ 1, ofReal (∫ v : ℝ in Ioo (-(1 - u)) (1 - u), (1 - (u - v) * (u + v))⁻¹) := by
      congr 2
      all_goals
    ...
    _ = (2 * ∫⁻ u : ℝ in Ioo 0 2⁻¹, ofReal (∫ v : ℝ in (-u)..u, (1 - (u - v) * (u + v))⁻¹)) +
        2 * ∫⁻ u : ℝ in Ioo 2⁻¹ 1, ofReal (∫ v : ℝ in -(1 - u)..(1 - u), (1 - (u - v) * (u + v))⁻¹) := by
      congr 2
      · refine setLIntegral_congr_fun measurableSet_Ioo fun u hu => ?_
      ...
      · refine setLIntegral_congr_fun measurableSet_Ioo fun u hu => ?_
        ...
        simp only [intervalIntegral_eq_integral_uIoc, hu2, uIoc_of_le hu2, ←integral_Ioc_eq_integral_Ioo]
        simp
    _ = (2 * ∫⁻ u : ℝ in Ioo 0 2⁻¹, ofReal (∫ v : ℝ in (-u)..u, (√(1 - u ^ 2) ^ 2 + v ^ 2)⁻¹)) +
        2 * ∫⁻ u : ℝ in Ioo 2⁻¹ 1, ofReal (∫ v : ℝ in -(1 - u)..(1 - u), (√(1 - u ^ 2) ^ 2 + v ^ 2)⁻¹) := by
      congr 2
      all_goals
      · refine setLIntegral_congr_fun measurableSet_Ioo fun u hu => ?_
        congr 1
    ...
    _ = (2 * ∫⁻ u : ℝ in Ioo 0 2⁻¹, ofReal (2 * (√(1 - u ^ 2))⁻¹ * arctan (u / √(1 - u ^ 2)))) +
        2 * ∫⁻ u : ℝ in Ioo 2⁻¹ 1, ofReal (2 * (√(1 - u ^ 2))⁻¹ * arctan ((1 - u) / √(1 - u ^ 2))) := by
      congr 2
      all_goals
      · refine setLIntegral_congr_fun measurableSet_Ioo fun u hu => ?_
        congr 1
    ...
    _ = (2 * ofReal (∫ u : ℝ in Ioo 0 2⁻¹, 2 * (√(1 - u ^ 2))⁻¹ * arctan (u / √(1 - u ^ 2)))) +
        2 * ofReal (∫ u : ℝ in Ioo 2⁻¹ 1, 2 * (√(1 - u ^ 2))⁻¹ * arctan ((1 - u) / √(1 - u ^ 2))) := by
      congr 2
      · rw [ofReal_integral_eq_lintegral_ofReal]
        · apply IntegrableOn.integrable
          rw [←intervalIntegrable_iff_integrableOn_Ioo_of_le (by norm_num)]
    ...
    _ = ofReal (2 * (∫ u : ℝ in 0..2⁻¹, 2 * (√(1 - u ^ 2))⁻¹ * arctan (u / √(1 - u ^ 2)))) +
        ofReal (2 * (∫ u : ℝ in 2⁻¹..1, 2 * (√(1 - u ^ 2))⁻¹ * arctan ((1 - u) / √(1 - u ^ 2)))) := by
      congr 1
      all_goals
      · rw [←integral_Ioc_eq_integral_Ioo, intervalIntegral_eq_integral_uIoc]
        norm_num
    _ = ofReal (2 * (∫ u : ℝ in 0..2⁻¹, 2 * (√(1 - u ^ 2))⁻¹ * arctan (u / √(1 - u ^ 2))) +
                2 * (∫ u : ℝ in 2⁻¹..1, 2 * (√(1 - u ^ 2))⁻¹ * arctan ((1 - u) / √(1 - u ^ 2)))) := by
      rw [ofReal_add]
      all_goals
    ...
    _ = ofReal (π ^ 2 / 6) := by
      ...
      congr 1
      calc
        _ = (2 * (∫ u : ℝ in 0..2⁻¹, 2 * (√(1 - u ^ 2))⁻¹ * arctan (u / √(1 - u ^ 2)))) +
        (2 * (∫ u : ℝ in 2⁻¹..1, 2 * (√(1 - u ^ 2))⁻¹ * arctan ((1 - u) / √(1 - u ^ 2)))) := rfl
        _ = (2 * ∫ u : ℝ in 0..2⁻¹, deriv g u) + 2 * (∫ u : ℝ in 2⁻¹..1, deriv h u) := by
          congr 2
